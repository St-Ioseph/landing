...
const WspButton = () => {
  return (
    <a
      ...
      className="flex justify-center items-center bg-bgDark2 hover:bg-bgDark3 border border-primaryColor border-solid rounded-xl w-64 sm:w-52 h-12 font-medium text-primaryText transition cursor-pointer shine-effect"
      href="https://wa.me/+5492613337751?text=Te escribo desde `ioseph.dev`. Mi nombre es "
      target="_blank"
